...
from .utils.preprocessing import load_img, load_skeleton, get_bbox, process_bbox
from .utils.preprocessing import augmentation, transform_input_to_output_space, trans_point2d
...
class DataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        self.train_dataset = Dataset(self.transform, "train", self.annot_subset)
        self.val_dataset = Dataset(self.transform, "test", self.annot_subset)
        self.test_dataset = Dataset(self.transform, "test", self.annot_subset)
    ...
    def add_data_specific_args(parent_parser):
        ...
        parser.add_argument('--annot_subset', default='human_annot', type=str, help='dataset subset')
        return parser
